...
> wget https://github.com/ZerBea/hcxtools/archive/refs/tags/6.2.5.zip
> install libcurl4-openssl-dev libssl-dev zlib1g-dev
> make
> sudo make install
'''

class hashie(plugins.Plugin):
    __author__ = 'junohea.mail@gmail.com edited by NeonLightning'
    __version__ = '1.0.4'
    __license__ = 'GPL3'
    __description__ = '''
