...
|------------------------------------------|----------------------------------------------------------------------------------------------|
| `main.plugins.weather2pwn.enabled`       | Enable or disable the plugin. (`true` or `false`)                                           |
...
main.plugins.weather2pwn.gps_loc = "/dev/ttyACM0"
...
#### sorted-password-list Example
```ini
main.plugins.sorted-password-list.show_number = true
main.plugins.sorted-password-list.keep_qr = false
...
main.plugins.sorted-password-list.qr_display = true
```
...
### Additional Notes
- Customize plugin configurations to suit your setup.
- Ensure all required libraries and dependencies are installed before enabling plugins.
